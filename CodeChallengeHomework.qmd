...
library(data.table)
combine_raw <- fread("C:/Users/Jmons/OneDrive/Documents/R-Class work/code_challenge/input_data/combine_raw.csv", select = c("V1", "Var1", "Var2", "Freq"))  # Selecting only required columns)
scls_aoi_attributes <- fread("C:/Users/Jmons/OneDrive/Documents/R-Class work/code_challenge/input_data/scls_aoi_attributes.csv", select = c("VALUE", "LABEL", "DESCRIPTION"))  # Selecting only required columns)
...
# View the result
print(head(merge2))
bps_aoi_attributes <- fread("C:/Users/Jmons/OneDrive/Documents/R-Class work/code_challenge/input_data/bps_aoi_attributes.csv") 
